...
def test_acar_from_ocat(proseco_agasc_1p7):
    ...
    exp = [
        ...
        "--- ---- -------- ---- ----- ------- ------- ------ ------",
        "  1    0        1  FID  7.00   928.4  -842.9 -180.5 -163.9",
        "  2    1        3  FID  7.00    45.8  -976.0   -3.4 -190.8",
        "  3    2        5  FID  7.00 -1819.6  1055.1  372.5  216.4",
        "  4    3 31983336  BOT  8.64   882.3 -1609.6 -171.8 -318.3",
        "  5    4 31075368  BOT  9.13    58.2   751.6   -5.3  155.6",
        "  6    5 32374896  BOT  9.17  2011.4 -2038.5 -401.0 -406.2",
        "  7    6 31075128  BOT  9.35  -309.2  1200.5   68.5  245.7",
        "  8    7 31463496  BOT  9.46  2036.9  1383.0 -404.1  284.5",
        "  9    0 31076560  ACQ  9.70  -934.0  -353.0  193.3  -66.3",
    ]
